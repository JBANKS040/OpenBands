...
# forge script scripts/base-mainnet/deployment/DeploymentForHonkVerifier1024.s.sol \
#     --broadcast \
...
echo "Deploying & Verifying the HonkVerifier and PositionAndSalaryProof1024Verifier contract on Base mainnet..."
forge script scripts/base-mainnet/deployment/DeploymentForHonkVerifier1024.s.sol --slow --multi --broadcast --private-key ${BASE_MAINNET_PRIVATE_KEY} --verify --etherscan-api-key ${BASESCAN_API_KEY}
